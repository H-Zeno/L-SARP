...
When the goal is not yet achieved, please call the update_task_plan function with a detailed description of why the goal is not yet achieved, the current situation and what went different to the original plan.
